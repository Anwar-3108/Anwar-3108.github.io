...
menuIcon.onclick = () => {
  ...
  navbar.classList.toggle('active')
    ...
    function NewTab() {
      window.open(
        "https://drive.google.com/file/d/1eoXTPQ3hVgc5ISUgplUiHvXholXPf5GU/view?usp=sharing",
        "_blank"
      );
    }
...
const typed = new Typed('.multiple-text', {
  strings: ['Full Stack', 'Front-End', 'as well as a','Backend Developer'],
  typeSpeed: 100,
  backSpeed: 100,
  backdelay: 1000,
  loop: true
...
GitHubCalendar(".calendar", "Anwar-3108");

// or enable responsive functionality:
GitHubCalendar(".calendar", "Anwar-3108", { responsive: true });
